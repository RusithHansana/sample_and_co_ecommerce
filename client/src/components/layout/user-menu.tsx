...
export function UserMenu() {
    ...
    if (!isAuthenticated || !user) {
        return (
            <Link
                className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] px-3 font-body text-sm font-medium rounded-md hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring no-underline"
                to="/login"
            >
                Sign In
            </Link>
